...
import {UniswapV6HookFactoryMock} from "./mocks/UniswapV6HookFactoryMock.sol";

contract UniswapV6HookFactoryTest is Test {
        
        UniswapV6HookFactoryMock factory;
        address tokenA = address(1);
        address tokenB = address(2);

        function setup() override public {
            factory = new UniswapV6HookFactoryMock(address(this));
        }
